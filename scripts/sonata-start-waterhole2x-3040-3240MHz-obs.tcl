...
sh echo "SonATA taking array" | mailx -s 'SonATA Testing taking array for WaterHole2x' -r peter@seti.org atauser@seti.org
...
# .sse-waterhole2x-band2-parms.tcl current
...
db set name {waterhole2x} current 
...
dx set baseinitaccum 10 current 
...
dx set daddthresh 8.500000000 current 
...
sched set beginfreq 3040.000000000 current 
sched set catshigh {habcat} current 
...
sched set endfreq 3240.000000000 current 
...
sched set targetmerit {meridian,catalog,completelyobs,timeleft} current 
