...
# special edition for kepler targets
# SSE seeker commands to start observing

# send out "taking the array" email
sh echo "SonATA taking array" | mailx -s 'SonATA Testing taking array for tests' -r peter@seti.org atauser@seti.org

exec setAlarm ARM,sonata,cygnusx3-explanets
