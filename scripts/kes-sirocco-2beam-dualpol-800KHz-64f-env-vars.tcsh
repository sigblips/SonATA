...
setenv RUNSSE_CHAN_HOSTS "chanhost1x chanhost2y"
...
setenv CHANHOST1Y "sirocco"
setenv CHANHOST2X "sirocco"
setenv CHANHOST2Y "sirocco"
setenv CHANHOST3X "sirocco"
setenv CHANHOST3Y "sirocco"
# Channelizer Names
...
setenv CHANOPTS "-C 8 -c 8 -N 10 -O 0.25 -B 6.5536 -d $FILTER_DIR/LS8c10f25o70d.flt  -w 1 -F 1420.0 -m"

# Beam Specific Command Line options for Channelizers
setenv CHANHOST1X_OPTS "-P X  -i 50000 -j 51000 -I 226.1.50.1 -J 127.0.0.1"
setenv CHANHOST1Y_OPTS "-P Y  -i 50003 -j 51000 -I 226.1.50.2 -J 127.0.0.1"
setenv CHANHOST2X_OPTS "-P X  -i 50002 -j 52000 -I 226.2.50.1 -J 127.0.0.1"
setenv CHANHOST2Y_OPTS "-P Y  -i 50001 -j 52000 -I 226.2.50.2 -J 127.0.0.1"
setenv CHANHOST3X_OPTS "-P X  -i 50004 -j 53000 -I 226.3.50.1 -J 127.0.0.1"
setenv CHANHOST3Y_OPTS "-P Y  -i 50005 -j 53000 -I 226.3.50.2 -J 127.0.0.1"

# DX Environmental Variables
#---------------------------

# Logical Host Names
setenv RUNSSE_DX_HOSTS "dxhost1 dxhost4" # dxhost3"

# Actual Host Names
setenv DXHOST1 "sirocco"
setenv DXHOST2 "sirocco"
setenv DXHOST3 "sirocco"
setenv DXHOST4 "sirocco"
setenv DXHOST5 "sirocco"
setenv DXHOST6 "sirocco"
setenv DXHOST7 "sirocco"
setenv DXHOST8 "sirocco"
setenv DXHOST9 "sirocco"
...
setenv DX_OPTS "-f 10 -z $FILTER_DIR/LS256c10f25o70d.flt -F 64 -w .8192 -T 2048"
...
setenv DXHOST4_OPTS "$DX_OPTS $BEAM2_DX_OPTS $YPOL_ONLY"
...
${HOME}/sonata_install/scripts/kes-switchConfigFile-2beam-2dx.tcsh
