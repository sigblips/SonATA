...
sh echo "SonATA taking array" | mailx -s 'SonATA taking array for Galactic Center Survey' -r peter@seti.org atauser@seti.org

exec setAlarm ARM,sonata,GCS
