...
# kes-sirocco-1beam-xpol-1_6MHz_32f_env_vars
...
setenv CHANOPTS "-C 8 -c 8 -N 10 -O 0.25 -B 13.1072 -d $FILTER_DIR/LS8c10f25o70d.flt  -w 1 -F 1420.0 -m"
...
setenv DX_OPTS "-f 10 -z $FILTER_DIR/LS256c10f25o70d.flt -F 32 -w 1.6384 -T 4096"
