...
sh echo "SonATA taking array" | mailx -s 'SonATA taking array for CygnusX3' -r peter@seti.org atauser@seti.org

exec setAlarm ARM,sonata,cygnusx3
...
## new baseline settings for SonATA
dx set baseerror                  on
dx set baseerrormeanlower   300.000000000
dx set baseerrormeanupper 4500.000000000
dx set baseerrorrange  15000.000000000
dx set baseerrorstddev   500.000000000
dx set basewarn                   on
dx set basewarnmeanlower   450.000000000
dx set basewarnmeanupper 3500.000000000
dx set basewarnrange   13000.000000000
dx set basewarnstddev   300.000000000
###############################################33
