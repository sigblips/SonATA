...
<%--
Purpose: show the current error log
--%>
...
<html>
<head>
<title> SonATA Operations: Error Log</title>
...
<c:set var="filename" value="permlogs/errorlogs/errorlog-${fileDateString}.txt"/>
