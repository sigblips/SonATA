...
VSOP87Coefficient g_L0VenusCoefficients[] =
{ 
  { 317614667, 0,         0 },
...
VSOP87Coefficient g_L1VenusCoefficients[] =
{ 
  { 1021352943053.0, 0,       0 },
...
VSOP87Coefficient g_L2VenusCoefficients[] =
{ 
  { 54127, 0,      0 },
...
VSOP87Coefficient g_L3VenusCoefficients[] =
{ 
  { 136, 4.804, 10213.286 },
  { 78,  3.67,  20426.57},
  { 26,  0,     0 }
...
VSOP87Coefficient g_L4VenusCoefficients[] =
{ 
  { 114, 3.1416, 0 },
  { 3,   5.21,   20426.57 },
  { 2,   2.51,   10213.29 }
...
VSOP87Coefficient g_L5VenusCoefficients[] =
{ 
  { 1, 3.14, 0 },
};


VSOP87Coefficient g_B0VenusCoefficients[] =
{ 
...
VSOP87Coefficient g_B1VenusCoefficients[] =
{ 
...
VSOP87Coefficient g_B2VenusCoefficients[] =
{ 
...
VSOP87Coefficient g_B3VenusCoefficients[] =
{ 
  { 647, 4.992, 10213.286 },
  { 20,  3.14,  0 },
  { 6,   0.77,  20426.57 },
...
VSOP87Coefficient g_B4VenusCoefficients[] =
{ 
  { 14, 0.32, 10213.29 }
};


VSOP87Coefficient g_R0VenusCoefficients[] =
{ 
  { 72334821, 0,        0 },
...
VSOP87Coefficient g_R1VenusCoefficients[] =
{ 
...
VSOP87Coefficient g_R2VenusCoefficients[] =
{ 
...
VSOP87Coefficient g_R3VenusCoefficients[] =
{ 
  { 50, 3.22, 10213.29 }
};

VSOP87Coefficient g_R4VenusCoefficients[] =
{ 
  { 1, 0.92, 10213.29 }
};
