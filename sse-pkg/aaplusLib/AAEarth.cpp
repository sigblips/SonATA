...
VSOP87Coefficient g_L0EarthCoefficients[] =
{ 
  { 175347046, 0,         0 },
...
VSOP87Coefficient g_L1EarthCoefficients[] =
{ 
  { 628331966747.0, 0,          0 },
...
VSOP87Coefficient g_L2EarthCoefficients[] =
{ 
  { 52919,  0,      0 },
...
VSOP87Coefficient g_L3EarthCoefficients[] =
{ 
  { 289, 5.844, 6283.076 },
  { 35,  0,     0 },
  { 17,  5.49,  12566.15 },
...
VSOP87Coefficient g_L4EarthCoefficients[] =
{ 
  { 114, 3.142,  0 }, 
  { 8,   4.13,   6283.08 },
  { 1,   3.84,   12566.15 }
...
VSOP87Coefficient g_L5EarthCoefficients[] =
{ 
  { 1, 3.14, 0 },
};


VSOP87Coefficient g_B0EarthCoefficients[] =
{ 
  { 280, 3.199, 84334.662 },
  { 102, 5.422, 5507.553 },
  { 80,  3.88,  5223.69},
...
VSOP87Coefficient g_B1EarthCoefficients[] =
{ 
  { 9, 3.90, 5507.55 },
  { 6, 1.73, 5223.69}
};

VSOP87Coefficient g_B2EarthCoefficients[] =
{ 
...
VSOP87Coefficient g_B3EarthCoefficients[] =
{ 
  { 647, 4.992, 10213.286 },
  { 20,  3.14,  0 },
  { 6,   0.77,  20426.57 },
...
VSOP87Coefficient g_B4EarthCoefficients[] =
{ 
  { 14, 0.32, 10213.29 }
};


VSOP87Coefficient g_R0EarthCoefficients[] =
{ 
  { 100013989,  0,          0 },
...
VSOP87Coefficient g_R1EarthCoefficients[] =
{ 
...
VSOP87Coefficient g_R2EarthCoefficients[] =
{ 
...
VSOP87Coefficient g_R3EarthCoefficients[] =
{ 
  { 145,  4.273,  6283.076 },
  { 7,    3.92,   12566.15 }
};

VSOP87Coefficient g_R4EarthCoefficients[] =
{ 
  { 4, 2.56, 6283.08 }
};


VSOP87Coefficient g_L1EarthCoefficientsJ2000[] =
{ 
  { 628307584999.0, 0,          0 },
  { 206059,         2.678235,   6283.075850 },
  { 4303,           2.6351,     12566.1517 },
...
VSOP87Coefficient g_L2EarthCoefficientsJ2000[] =
{ 
...
VSOP87Coefficient g_L3EarthCoefficientsJ2000[] =
{ 
  { 289,  5.842,  6283.076 },
  { 21,   6.05,   12566.15 },
  { 3,    5.20,   155.42 },
...
VSOP87Coefficient g_L4EarthCoefficientsJ2000[] =
{ 
  { 8,  4.14, 6283.08 },
  { 1,  3.28, 12566.15 }
};
...
VSOP87Coefficient g_B1EarthCoefficientsJ2000[] =
{ 
...
VSOP87Coefficient g_B2EarthCoefficientsJ2000[] =
{ 
...
VSOP87Coefficient g_B3EarthCoefficientsJ2000[] =
{ 
  { 276,  0.595,  6283.076 },
  { 17,   3.14,   0 },
  { 4,    0.12,   12566.15 }
...
VSOP87Coefficient g_B4EarthCoefficientsJ2000[] =
{ 
  { 6,  2.27, 6283.08 },
  { 1,  0,    0 }
};
...
double CAAEarth::EclipticLatitude(double JD)
{
  ...
  //Calculate B2
  int nB2Coefficients = sizeof(g_B2EarthCoefficients) / sizeof(VSOP87Coefficient);
  double B2 = 0;
  for (i=0; i<nB2Coefficients; i++)
    B2 += g_B2EarthCoefficients[i].A * cos(g_B2EarthCoefficients[i].B + g_B2EarthCoefficients[i].C*rho);

  //Calculate B3
  int nB3Coefficients = sizeof(g_B3EarthCoefficients) / sizeof(VSOP87Coefficient);
  double B3 = 0;
  for (i=0; i<nB3Coefficients; i++)
    B3 += g_B3EarthCoefficients[i].A * cos(g_B3EarthCoefficients[i].B + g_B3EarthCoefficients[i].C*rho);

  //Calculate B4
  int nB4Coefficients = sizeof(g_B4EarthCoefficients) / sizeof(VSOP87Coefficient);
  double B4 = 0;
  for (i=0; i<nB4Coefficients; i++)
    B4 += g_B4EarthCoefficients[i].A * cos(g_B4EarthCoefficients[i].B + g_B4EarthCoefficients[i].C*rho);
