...
VSOP87Coefficient g_L0UranusCoefficients[] =
{ 
  { 548129294,	0,        	0 },
...
VSOP87Coefficient g_L1UranusCoefficients[] =
{ 
  { 7502543122.0,	0,	      0 },
...
VSOP87Coefficient g_L2UranusCoefficients[] =
{ 
  { 53033,  0,      0 },
  { 2358,   2.2601, 74.7816 },
  { 769,    4.526,  11.046 },
...
VSOP87Coefficient g_L3UranusCoefficients[] =
{ 
  { 121,  0.024,  74.782 },
  { 68,   4.12,   3.93 },
  { 53,   2.39,   11.05 },
...
VSOP87Coefficient g_L4UranusCoefficients[] =
{ 
  { 114,  3.142,  0 },
  { 6,    4.58,   74.78 },
  { 3,    0.35,   11.05 },
...
VSOP87Coefficient g_B0UranusCoefficients[] =
{ 
...
VSOP87Coefficient g_B1UranusCoefficients[] =
{ 
...
VSOP87Coefficient g_B2UranusCoefficients[] =
{ 
  { 9212, 5.8004, 74.7816 },
  { 557,  0,      0},
  { 286,  2.177,  149.563 },
...
VSOP87Coefficient g_B3UranusCoefficients[] =
{ 
  { 268,  1.251,  74.782 },
  { 11,   3.14,   0 },
  { 6,    4.01,   149.56 },
...
VSOP87Coefficient g_B4UranusCoefficients[] =
{ 
  { 6,  2.85, 74.78 }
};

VSOP87Coefficient g_R0UranusCoefficients[] =
{ 
  { 1921264848,   0,          0 },
...
VSOP87Coefficient g_R1UranusCoefficients[] =
{ 
...
VSOP87Coefficient g_R2UranusCoefficients[] =
{ 
...
VSOP87Coefficient g_R3UranusCoefficients[] =
{ 
  { 1164,   4.7345, 74.7816 },
  { 212,    3.343,  63.736 },
  { 196,    2.980,  70.849 },
...
VSOP87Coefficient g_R4UranusCoefficients[] =
{ 
  { 53, 3.01, 74.78 },
  { 10, 1.91, 56.62 }
};
