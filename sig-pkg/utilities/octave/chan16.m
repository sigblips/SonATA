...
# Program to read a capture file of channel packets, 
# compute the spectrum and plot the result.

# Note: a beam packet has a 64-byte header followed by 1024
# complex 16-bit values,  for a total packet length of 4160.
