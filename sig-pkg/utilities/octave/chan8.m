...
# Program to read a capture file of setiQuest capture packets,
# compute the spectrum and plot the result.

# Note: a setiQuest packet has a 64-byte header followed by 1024
# complex 8-bit values, for a total packet length of 2112.
...
for n = 1:N
	h = fread(fd, 64, "uchar");
	s = fread(fd, 2048, "signed char");
	cmplx(1:1024) = s(1:2:2048) + s(2:2:2048) * i;
