...
void MulticasterTest::testSinglePublish ()
{
    ...
    cu_assert (m_multicaster->subscribe (m_o1, "alpha"));
    cu_assert (m_multicaster->publish (NULL, "alpha", value));

    cu_assert (*m_o1 == Observer ("alpha", 1));
...
void MulticasterTest::testMultipleHomogenousPublish ()
{
    ...
    cu_assert (m_multicaster->subscribe (m_o1, "alpha"));
    cu_assert (m_multicaster->subscribe (m_o2, "alpha"));
    cu_assert (m_multicaster->subscribe (m_o3, "alpha"));
    cu_assert (m_multicaster->subscribe (m_o4, "alpha"));
    cu_assert (m_multicaster->publish (NULL, "alpha", value));

    cu_assert (*m_o1 == Observer ("alpha", 1));
    cu_assert (*m_o2 == Observer ("alpha", 1));
    cu_assert (*m_o3 == Observer ("alpha", 1));
    cu_assert (*m_o4 == Observer ("alpha", 1));
...
void MulticasterTest::testMultipleHeterogenousPublish ()
{
    ...
    cu_assert (m_multicaster->subscribe (m_o1, "alpha"));
    cu_assert (m_multicaster->subscribe (m_o2, "beta"));
    cu_assert (m_multicaster->subscribe (m_o3, "alpha"));
    cu_assert (m_multicaster->subscribe (m_o4, "beta"));
    cu_assert (m_multicaster->publish (NULL, "alpha", value));

    cu_assert (*m_o1 == Observer ("alpha", 1));
    cu_assert (*m_o2 == Observer ());
    cu_assert (*m_o3 == Observer ("alpha", 1));
    cu_assert (*m_o4 == Observer ());
...
void MulticasterTest::testSingleUnsubscribe ()
{
    ...
    cu_assert (m_multicaster->subscribe (m_o1, "alpha"));
    cu_assert (m_multicaster->subscribe (m_o2, "alpha"));
    cu_assert (m_multicaster->unsubscribe (m_o1, "alpha"));
    cu_assert (m_multicaster->publish (NULL, "alpha", value));

    cu_assert (*m_o1 == Observer ());
    cu_assert (*m_o2 == Observer ("alpha", 1));
...
void MulticasterTest::testSimpleUnsubscribeAll ()
{
    ...
    cu_assert (m_multicaster->subscribe (m_o1, "alpha"));
    cu_assert (m_multicaster->subscribe (m_o1, "beck"));
    cu_assert (m_multicaster->subscribe (m_o1, "gamma"));
    m_multicaster->unsubscribeFromAll (m_o1);
    cu_assert (m_multicaster->publish (NULL, "alpha", value));
    cu_assert (m_multicaster->publish (NULL, "beck", value));
    cu_assert (m_multicaster->publish (NULL, "gamma", value));
    cu_assert (*m_o1 == Observer ());
...
void MulticasterTest::testComplexUnsubscribeAll ()
{
    ...
    cu_assert (m_multicaster->subscribe (m_o1, "beck"));
    cu_assert (m_multicaster->subscribe (m_o1, "gamma"));
    cu_assert (m_multicaster->subscribe (m_o2, "beck"));
    cu_assert (m_multicaster->subscribe (m_o2, "gamma"));
    cu_assert (m_multicaster->subscribe (m_o2, "demeter"));
    m_multicaster->unsubscribeFromAll (m_o2);

    cu_assert (m_multicaster->publish (NULL, "alpha", value));
    cu_assert (m_multicaster->publish (NULL, "beck", value));
    cu_assert (m_multicaster->publish (NULL, "gamma", value));
    cu_assert (m_multicaster->publish (NULL, "demeter", value));
    cu_assert (*m_o1 == Observer ("gamma", 3));
    cu_assert (*m_o2 == Observer ());
